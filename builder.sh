...
terraform init -var-file=../../secrets.tfvars -backend-config=backend
terraform apply -var-file=../../secrets.tfvars -var "reference=network/terraform.state" -auto-approve
